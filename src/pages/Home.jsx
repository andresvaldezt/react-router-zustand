    ...
    return(
        ...
        <main className="index-main">
            <section className="in-header">
                ...
                <form className="jobs-search" action="search" role="search" onSubmit={handleSearch}>
                    <div className="search-bar">
                        ...
                        <input name="search" type="text" placeholder="Buscar empleos por titulo, habilidad o empresa"/>
            ...
            <section>
                <header>
                    ...
                    <p>
                        DevJobs es la principal plataforma de
                        búsqueda de empleo para desarrolladores.
                        Conectamos a los mejores talentos con las
                        empresas más innovadoras.
                    </p>
                </header>
                <footer>
                    <article className="in-articles">
